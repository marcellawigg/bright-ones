  ...
  $('#submit-button').on('click', function(){
    ...
    $.ajax({
      ...
      success: function (idea){
        var formatIdea = '<div class="any-idea"> <p> <div class="created-idea" data-idea-id = ' + idea.id + ' id="idea"> <ul> <strong>Title: </strong> <li class="idea-title-info" data-title-id = ' + idea.id + ' contentEditable="true">' + idea.title + '</li> <strong>Body: </strong><li class="idea-body-info" data-body-id = ' + idea.id + ' contentEditable="true">' + idea.body + '</li><strong>Quality: </strong> <li id="idea-quality-show">' + idea.quality + '</li> <button class="upgrade-quality" type="button"> Up </button> <button class="downgrade-quality" type="button"> Down </button> <div class="remove-button"> <input type="submit" value="Delete"> </div> </ul> </p> </div> </div>';
